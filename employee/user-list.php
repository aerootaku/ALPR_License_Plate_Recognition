								...
								<div class="row">
									...
									?>
													<tr>
														...
														<td><?php echo $row['lastname'].",".$row['firstname']." ".$row['lastname']; ?></td>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" href="activation-submit.php?id=<?php echo $id ?>">
																	<i class="ace-icon fa fa-reply icon-only"></i>
																</a>
																	
																<a class="red" href="user-list-delete.php?id=<?php echo $id ?>">
