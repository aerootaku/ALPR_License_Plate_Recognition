...
if($type=='sadmin'){
	$users_adminID=$_SESSION['id'];
$actions="Logged-in.";
$sql=("INSERT INTO tbl_logs(user_adminID, dt, action) VALUES ('$users_adminID','$dt','$actions')"); 
    	(mysqli_query($conn, $sql)); 
	// Check the department of username and password
		// if($type=='admin')
		// {
...
echo"<script>alert('Welcome $unames')</script>";
		echo"<script>window.location='sadmin/dashboard.php'</script>";
}}
