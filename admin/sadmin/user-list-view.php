	...
	<form class='form-horizontal' role='form' action='user-list-edit.php?id=<?php echo $id; ?>' method='POST'>
		<div class="row">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="form-field-1" placeholder="Username" name="username" value="<?php echo $usernames; ?>" class="col-xs-10 col-sm-5" readonly />
				</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<textarea id="form-field-1" placeholder="Address" class="col-xs-10 col-sm-5" name="address" readonly><?php echo $address; ?></textarea>
			</div>
		</div>		
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" id="form-field-1" placeholder="Contact" class="input-mask-phone col-xs-10 col-sm-5" id="form-field-mask-2" name="phone" value="<?php echo $phne; ?>" readonly/>
			</div>
		</div>
				...
				<table class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td> <a class="green" href="car-edit.php?id=<?php echo $id ?>">
								<i class="ace-icon fa fa-pencil bigger-130"></i>
							</a>
							<a class="red" href="models.php?do=deleteCar&id=<?php echo $id ?>" onClick="return confirm('Are you sure you want to delete this?')">
