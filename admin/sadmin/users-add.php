...
?>
			<div class="row">
				<form class='form-horizontal' id='' role='form' action='models.php?do=addUserAdmin' method='POST'>
				<div class="row">
				...
				<div class="form-group">
						...
						<div class="col-xs-12 col-sm-9">
							<div class="clearfix">
								<input type="text" id="name" placeholder="Name" name="name" class="col-xs-12 col-sm-6" pattern="[a-zA-Z\s]+" tittle="Letters only" required />
							</div>
						</div>
				</div>
				...
				<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="clearfix">
								<input name="password" type="password" title="Password must contain at least 8 characters, including UPPER/lowercase, special characters and numbers" placeholder="Password" autocomplete="new-password" required pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,}$" />
							</div>
						</div>
				</div>
				<div class="space-2"></div>
