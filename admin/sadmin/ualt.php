...
<hr>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<p><a href="new-announcement.php">User Logs</a></p>
											</div>
										</div><!-- /.modal-content -->
                  ...
                  <th>Date / Time</th>     
												...
												$sql=mysql_query("SELECT *,l.id as uaid FROM tbl_users u INNER JOIN tbl_logs l ON u.id=l.user_adminID  ORDER BY l.id ASC")or die(mysql_error());
