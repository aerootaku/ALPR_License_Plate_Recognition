									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<p><a href="new-announcement.php">New Announcements</a></p>
											</div>
										</div><!-- /.modal-content -->
									...
									<div class="col-xs-12">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												$speedfine=mysql_query("select * from tbl_speed_fine")or die(mysql_error());
												while($row=mysql_fetch_array($speedfine)){ 
													$id=$row['id'];
												
									?>
													<tr>
 
														<td><?php echo $row['speed_from']; ?></td>
														<td><?php echo $row['speed_to']; ?></td>
...
<!-- 																<a class="blue" href="#">
																...
																<a class="green" href="speed-fine-edit.php?id=<?php echo $id ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="models.php?do=deleteSpeedFine&id=<?php echo $id ?>">
