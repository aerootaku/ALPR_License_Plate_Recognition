...
?>
			<div class="row">
			<form class='form-horizontal' role='form' action='users-edit.php?id=<?php echo $id; ?>' method='POST'>
				<div class="row">
				...
				<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="form-field-1" placeholder="Name" name="name" value="<?php echo $name; ?>" class="col-xs-10 col-sm-5" readonly />
						</div>
				</div>
				<div class="form-group">
