									...
									<div class="col-xs-12">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												$announcement=mysql_query("select * from tbl_announcements")or die(mysql_error());
												while($row=mysql_fetch_array($announcement)){ 
													$id=$row['id'];
...
<!-- 																<a class="blue" href="#">
																...
																<a class="green" href="announcement-edit.php?id=<?php echo $id ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" href="models.php?do=deleteAnn&id=<?php echo $id ?>">
